...
DEFINE_GUID(IID_ICormanLisp, 0x3a6ac641, 0xeaf, 0x11d1, 0xac, 0xb9, 0x0, 0xa0, 0x24, 0x80, 0x32, 0x58);

// {F056CAF1-128E-11d1-ACB9-00A024803258}
DEFINE_GUID(IID_ICormanLispTextOutput, 0xf056caf1, 0x128e, 0x11d1, 0xac, 0xb9, 0x0, 0xa0, 0x24, 0x80, 0x32, 0x58);

// {F056CAF2-128E-11d1-ACB9-00A024803258}
DEFINE_GUID(IID_ICormanLispStatusMessage, 0xf056caf2, 0x128e, 0x11d1, 0xac, 0xb9, 0x0, 0xa0, 0x24, 0x80, 0x32, 0x58);

// {3EB3AE13-F3B9-4e19-BA6C-0354913612A6}
DEFINE_GUID(IID_ICormanLispDirectCall, 0x3eb3ae13, 0xf3b9, 0x4e19, 0xba, 0x6c, 0x3, 0x54, 0x91, 0x36, 0x12, 0xa6);

// {3C89B650-1878-4743-8690-CE77B1EB3493}
DEFINE_GUID(IID_ICormanLispShutdown, 0x3c89b650, 0x1878, 0x4743, 0x86, 0x90, 0xce, 0x77, 0xb1, 0xeb, 0x34, 0x93);
...
{
	STDMETHOD(Initialize)(THIS_ IUnknown * clientInterface, THIS_ const char* imageName, int clientType) PURE;
	...
	STDMETHOD(InitializeEx)(THIS_ IUnknown * clientInterface, THIS_ const char* imageName, int clientType,
							int heapReserve, int heapInitialSize, int ephemeralHeap1Size, int ephemeralHeap2Size) PURE;
