...
#define INVALID_HANDLE_VALUE  (0xffffffff) /*(HANDLE)(-1) */
...
typedef void *ENUMRESLANGPROC;
typedef void *ENUMRESNAMEPROC;
typedef void *ENUMRESTYPEPROC;
...
/* BOOL WINAPI IsBadReadPtr(PCVOID,UINT); already defined */
...
/*void WINAPI Sleep(DWORD); already defined -RGC */
...
#! (:export t :library "ADVAPI32" :ignore "APIENTRY" :pascal "WINAPI")
...
#! (:export t :library "USER32" :ignore "APIENTRY" :pascal "WINAPI")
