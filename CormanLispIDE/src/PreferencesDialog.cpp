...
char PrefsKeyValues[][2][128] = {
	...
	{__TEXT("Software\\Corman Technologies\\Corman Lisp\\3.0\\Editor Preferences\\AutoPrototypeOnMouseMove"),
	 __TEXT("1")},
	{__TEXT("Software\\Corman Technologies\\Corman Lisp\\3.0\\Editor Preferences\\AutoPrototypeOnKeyDown"),
	 __TEXT("1")},
	...
	{__TEXT("Software\\Corman Technologies\\Corman Lisp\\3.0\\Editor Preferences\\HighlightTextColor"),
	 __TEXT("0000c8")},
	{__TEXT("Software\\Corman Technologies\\Corman Lisp\\3.0\\Editor Preferences\\OutputTextColor"), __TEXT("800000")},
	{__TEXT("Software\\Corman Technologies\\Corman Lisp\\3.0\\Editor Preferences\\HintBackgroundColor"),
	 __TEXT("c0ffff")},
	...
	{__TEXT("Software\\Corman Technologies\\Corman Lisp\\3.0\\Editor Preferences\\RememberDocumentPositions"),
	 __TEXT("1")},
...
const int PrefsKeyValuesNum = sizeof(PrefsKeyValues) / sizeof(*PrefsKeyValues);
...
PreferencesDialog::PreferencesDialog(UINT nIDTemplate) : CDialog(nIDTemplate) {}
...
void PreferencesDialog::GetPreferencesInfo(PreferencesInfo* info)
{
	...
	for (int i = 0; r == ERROR_SUCCESS && i < PrefsKeyValuesNum; i++)
	{
		...
		r = RegQueryValue(HKEY_CURRENT_USER, (const char*)PrefsKeyValues[i][0], PrefsKeyValues[i][1], &d);
	}
...
void PreferencesDialog::SavePreferencesInfo(PreferencesInfo* info)
{
	...
	LONG r = ERROR_SUCCESS;
	for (int i = 0; r == ERROR_SUCCESS && i < PrefsKeyValuesNum; i++)
		r = RegSetValue(HKEY_CURRENT_USER, PrefsKeyValues[i][0], REG_SZ, PrefsKeyValues[i][1],
