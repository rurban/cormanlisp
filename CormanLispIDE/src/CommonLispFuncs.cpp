...
LambdaListString lambdaLists[] = {
	...
	"COMPILER-MACRO-FUNCTION fname &optional environment [Function]",
	"CONSTANTP",
	"CONSTANTP expression &optional environment [Function]",
	"DECLAIM",
	...
	"LOCALLY",
	"LOCALLY declaration* expression* [Special Operator]",
	"MACROEXPAND",
	"MACROEXPAND expression &optional environment [Function]",
	"MACROEXPAND-1",
	"MACROEXPAND-1 expression &optional environment [Function]",
	"MACRO-FUNCTION",
	"MACRO-FUNCTION symbol &optional environment [Function]",
	"PROCLAIM",
	"PROCLAIM declaration-spec [Function]",
	"SPECIAL-OPERATOR-P",
	"SPECIAL-OPERATOR-P symbol [Function]",
	"SYMBOL-MACROLET",
	"SYMBOL-MACROLET ((symbol expression)*) declaration* expression* [Special Operator]",
	"THE",
	...
	"TYPEP",
	"TYPEP object type &optional environment [Function]",
	...
	"CASE",
	"CASE object (key expression*)* [({t | otherwise} expression*)] [Macro]",
	"CATCH",
	"CATCH tag expression* [Special Operator]",
	"CCASE",
	"CCASE object (key expression*)* [Macro]",
	"COMPILED-FUNCTION-P",
	...
	"DEFCONSTANT",
	"DEFCONSTANT symbol expression [string] [Macro]",
	"DEFINE-MODIFY-MACRO",
	"DEFINE-MODIFY-MACRO name parameters symbol [string] [Macro]",
	...
	"DEFSETF",
	"DEFSETF reader parameters (var*) . body [Macro]",
	"DEFUN",
	"DEFUN fname parameters . body [Macro]",
	"DEFVAR",
	"DEFVAR symbol [expression [string]] [Macro]",
	"DESTRUCTURING-BIND",
	"DESTRUCTURING-BIND	variables tree declaration* expression* [Macro]",
	"ECASE",
	...
	"EQUALP",
	"EQUALP object1 object2 [Function]",
	"ETYPECASE",
	"ETYPECASE object (key expression*)* [Macro]",
	"EVERY",
	"EVERY predicate proseq &rest proseqs [Function]",
	"FBOUNDP",
	"FBOUNDP fname [Function]",
	"FDEFINITION",
	"FDEFINITION fname [Function]",
	"FLET",
	"FLET ((fname parameters . body)*) declaration* expression* [Special Operator]",
	"FMAKUNBOUND",
	...
	"LABELS",
	"LABELS ((fname parameters . body)*) declaration* expression* [Special Operator]",
	"GET-SETF-EXPANSION",
	"GET-SETF-EXPANSION place &optional environment [Function]",
	"GO",
	"GO tag [Special Operator]",
	"IDENTITY",
	"IDENTITY object [Function]",
	"IF",
	"IF test then [else] [Special Operator]",
	"LET",
	"LET ({symbol | (symbol [value])}*) declaration* expression* [Special Operator]",
	"LET*",
	"LET* ({symbol | (symbol [value])}*) declaration* expression* [Special Operator]",
	"MACROLET",
	"MACROLET ((symbol parameters . body)*) declaration* expression* [Special Operator]",
	"MULTIPLE-VALUE-BIND",
	"MULTIPLE-VALUE-BIND (symbol*) expression1 declaration* expression* [Macro]",
	"MULTIPLE-VALUE-CALL",
	"MULTIPLE-VALUE-CALL function expression* [Special Operator]",
	"MULTIPLE-VALUE-LIST",
	"MULTIPLE-VALUE-LIST expression [Macro]",
	"MULTIPLE-VALUE-PROG1",
	"MULTIPLE-VALUE-PROG1 expression1 expression* [Special Operator]",
	"MULTIPLE-VALUE-SETQ",
	"MULTIPLE-VALUE-SETQ (symbol*) expression [Macro]",
	"NOT",
	"NOT object [Function]",
	"NOTANY",
	"NOTANY predicate proseq &rest proseqs [Function]",
	"NOTEVERY",
	"NOTEVERY predicate proseq &rest proseqs [Function]",
	"NTH-VALUE",
	"NTH-VALUE n expression [Macro]",
	"OR",
	"OR expression* [Macro]",
	"PROG",
	"PROG ({symbol | (symbol [value]}*) declaration* {tag | expression}* [Macro]",
	"PROG*",
	"PROG* ({symbol | (symbol [value]}*) declaration* {tag | expression}* [Macro]",
	"PROG1",
	"PROG1 expression1 expression* [Macro]",
	"PROG2",
	"PROG2 expression1 expression2 expression* [Macro]",
	"PROGN",
	...
	"RETURN-FROM",
	"RETURN-FROM symbol expression [Special Operator]",
	"ROTATEF",
	"ROTATEF place* [Macro]",
	"SETF",
	"SETF {place value}* [Macro]",
	"SETQ",
	"SETQ {symbol value}* [Special Operator]",
	"SHIFTF",
	"SHIFTF place1 place* expression [Macro]",
	"SOME",
	...
	"TYPECASE",
	"TYPECASE object (type expression*)* [({t | otherwise} expression*)] [Macro]",
	"UNLESS",
	"UNLESS test expression* [Macro]",
	"UNWIND-PROTECT",
	"UNWIND-PROTECT expression1 expression* [Special Operator]",
	"VALUES",
	"VALUES &rest objects [Function]",
	"VALUES-LIST",
	"VALUES-LIST prolist [Function]",
	"WHEN",
	"WHEN test expression* [Macro]",

	// Iteration
	"DO",
	"DO ({var | (var [init [update]])}*) (test result*) declaration* {tag | expression}* [Macro]",
	"DO*",
	"DO* ({var | (var [init [update]])}*) (test result*) declaration* {tag | expression}* [Macro]",
	"DOLIST",
	"DOLIST (var list [result]) declaration* {tag | expression}* [Macro]",
	"DOTIMES",
	"DOTIMES (var integer [result]) declaration* {tag | expression}* [Macro]",
	"LOOP",
	...
	"ALLOCATE-INSTANCE",
	"ALLOCATE-INSTANCE class &rest initargs &key [Generic Function]",
	"CALL-METHOD",
	"CALL-METHOD method &optional next-methods [Macro]",
	"CALL-NEXT-METHOD",
	...
	"DEFINE-METHOD-COMBINATION symbol property* [Macro]", // short form
	//	"DEFINE-METHOD-COMBINATION","DEFINE-METHOD-COMBINATION symbol parameters (group-spec*) [(:arguments .
	// parameters2)] [(:generic-function var)] . body [Macro]",  // long form
	"DEFMETHOD",
	"DEFMETHOD fname qualifier* parameters . body [Macro]",
	"ENSURE-GENERIC-FUNCTION",
	"ENSURE-GENERIC-FUNCTION fname &key argument-precedence-order declare documentation environment "
	"generic-function-class lambda-list method-class method-combination [Function]",
	"FIND-CLASS",
	"FIND-CLASS symbol &optional error environment [Function]",
	"FIND-METHOD",
	"FIND-METHOD generic-function qualifiers specializers &optional error [Generic Function]",
	"FUNCTION-KEYWORDS",
	"FUNCTION-KEYWORDS method [Generic Function]",
	"INITIALIZE-INSTANCE",
	"INITIALIZE-INSTANCE instance &rest initargs &key [Generic Function]",
	"MAKE-INSTANCE",
	"MAKE-INSTANCE class &rest initargs &key [Generic Function]",
	"MAKE-INSTANCE-OBSOLETE",
	"MAKE-INSTANCE-OBSOLETE class [Generic Function]",
	"MAKE-LOAD-FORM",
	"MAKE-LOAD-FORM object &optional environment [Generic Function]",
	"MAKE-LOAD-FORM-SAVING-SLOTS",
	"MAKE-LOAD-FORM-SAVING-SLOTS instance &key slot-names environment [Function]",
	"METHOD-QUALIFIERS",
	"METHOD-QUALIFIERS method [Generic Function]",
	"NEXT-METHOD-P",
	"NEXT-METHOD-P [Function]",
	"NO-APPLICABLE-METHOD",
	"NO-APPLICABLE-METHOD generic-function &rest args [Generic Function]",
	"NO-NEXT-METHOD",
	...
	"SHARED-INITIALIZE",
	"SHARED-INITIALIZE instance names &rest initargs &key [Generic Function]",
	"SLOT-BOUNDP",
	"SLOT-BOUNDP instance symbol [Function]",
	"SLOT-EXISTS-P",
	"SLOT-EXISTS-P object symbol [Function]",
	"SLOT-MAKUNBOUND",
	"SLOT-MAKUNBOUND <instance> symbol [Function]",
	"SLOT-MISSING",
	"SLOT-MISSING class object symbol opname &optional value [Generic Function]",
	"SLOT-UNBOUND",
	"SLOT-UNBOUND class instance symbol [Generic Function]",
	"SLOT-VALUE",
	"SLOT-VALUE instance symbol [Function]",
	"WITH-ACCESSORS",
	"WITH-ACCESSORS ((var fname)*) instance declaration* expression* [Macro]",
	"WITH-SLOTS",
	"WITH-SLOTS ({symbol | (var symbol)}*) instance declaration* expression* [Macro]",
	"UNBOUND-SLOT-INSTANCE",
	"UNBOUND-SLOT-INSTANCE condition [Function]",
	"UPDATE-INSTANCE-FOR-DIFFERENT-CLASS",
	"UPDATE-INSTANCE-FOR-DIFFERENT-CLASS old new &rest initargs &key [Generic Function]",
	"UPDATE-INSTANCE-FOR-REDEFINED-CLASS",
	"UPDATE-INSTANCE-FOR-REDEFINED-CLASS instance added deleted plist &rest initargs [Generic Function]",

	// Structures
	"COPY-STRUCTURE",
	"COPY-STRUCTURE structure [Function]",
	"DEFSTRUCT",
	"DEFSTRUCT {symbol | (symbol property*)} [string] field* [Macro]",
	...
	"CERROR",
	"CERROR format cond &rest args [Function]",
	"CHECK-TYPE",
	...
	"ERROR",
	"ERROR cond &rest args [Function]",
	"FIND-RESTART",
	"FIND-RESTART r &optional condition [Function]",
	"HANDLER-BIND",
	"HANDLER-BIND ((type handler)*) expression* [Macro]",
	"HANDLER-CASE",
	"HANDLER-CASE test (type ([var]) declaration* expression* [(:no-error parameters declaration* expression*)] "
	"[Macro]",
	"IGNORE-ERRORS",
	"IGNORE-ERRORS expression* [Macro]",
	"INVALID-METHOD-ERROR",
	"INVALID-METHOD-ERROR method format &rest args [Function]",
	"INVOKE-DEBUGGER",
	"INVOKE-DEBUGGER condition [Function]",
	"INVOKE-RESTART",
	"INVOKE-RESTART restart &rest args [Function]",
	"INVOKE-RESTART-INTERACTIVELY",
	"INVOKE-RESTART-INTERACTIVELY restart [Function]",
	"MAKE-CONDITION",
	"MAKE-CONDITION type &rest args [Function]",
	"METHOD-COMBINATION-ERROR",
	"METHOD-COMBINATION-ERROR format &rest args [Function]",
	"MUFFLE-WARNING",
	"MUFFLE-WARNING &optional condition [Function]",
	"RESTART-BIND",
	"RESTART-BIND ((symbol function {key val}*)*) expression* [Macro]",
	"RESTART-CASE",
	"RESTART-CASE test (symbol parameters {key val}* declaration* expression*) [Macro]",
	"RESTART-NAME",
	"RESTART-NAME restart [Function]",
	"SIGNAL",
	"SIGNAL cond &rest args [Function]",
	"SIMPLE-CONDITION-FORMAT-ARGUMENTS",
	"SIMPLE-CONDITION-FORMAT-ARGUMENTS condition [Function]",
	"SIMPLE-CONDITION-FORMAT-CONTROL",
	"SIMPLE-CONDITION-FORMAT-CONTROL condition [Function]",
	"STORE-VALUE",
	"STORE-VALUE object &optional condition [Function]",
	"USE-VALUE",
	"USE-VALUE object &optional condition [Function]",
	"WARN",
	"WARN cond &rest args [Function]",
	"WITH-CONDITION-RESTARTS",
	"WITH-CONDITION-RESTARTS condition restarts expression* [Macro]",
	"WITH-SIMPLE-RESTART",
	"WITH-SIMPLE-RESTART (symbol format arg*) expression* [Macro]",

	// Symbols
	"BOUNDP",
	"BOUNDP symbol [Function]",
	"COPY-SYMBOL",
	"COPY-SYMBOL symbol &optional props-too [Function]",
	"GENSYM",
	...
	") package [Function]",
	"GET",
	"GET symbol key &optional default [Function]",
	"KEYWORDP",
	...
	"DO-ALL-SYMBOLS",
	"DO-ALL-SYMBOLS (var [result]) declaration* {tag | expression}* [Macro]",
	"DO-EXTERNAL-SYMBOLS",
	"DO-EXTERNAL-SYMBOLS (var [package [result]]) declaration* {tag | expression}* [Macro]",
	"DO-SYMBOLS",
	"DO-SYMBOLS (var [package [result]]) declaration* {tag | expression}* [Macro]",
	"EXPORT",
	...
	"SHADOW",
	"SHADOW names &optional package [Function]",
	"SHADOWING-IMPORT",
	...
	"WITH-PACKAGE-ITERATOR (symbol packages key*) declaration* expression* [Macro]",
	...
	"ASINH n [Function]",
	"ATAN",
	"ATAN n1 &optional (n2 1) [Function]",
	"ATANH",
	"ATANH n [Function]",
	"BOOLE",
	"BOOLE op i1 i2 [Function]",
	"BYTE",
	"BYTE length pos [Function]",
	"BYTE-POSITION",
	"BYTE-POSITION spec [Function]",
	"BYTE-SIZE",
	"BYTE-SIZE spec [Function]",
	"CEILING",
	"CEILING r &optional (d 1) [Function]",
	"CIS",
	"CIS r [Function]",
	"COMPLEX",
	"COMPLEX r1 &optional r2 [Function]",
	"COMPLEXP",
	...
	"DECF place [n] [Macro]",
	"DECODE-FLOAT",
	"DECODE-FLOAT f [Function]",
	"DENOMINATOR",
	"DENOMINATOR rational [Function]",
	"DEPOSIT-FIELD",
	"DEPOSIT-FIELD new spec i [Function]",
	"DPB",
	...
	"EXPT n1 n2 [Function]",
	"FCEILING",
	"FCEILING r &optional (d 1) [Function]",
	"FFLOOR",
	"FFLOOR r &optional (d 1) [Function]",
	"FLOAT",
	"FLOAT n &optional f [Function]",
	"FLOAT-DIGITS",
	"FLOAT-DIGITS f [Function]",
	"FLOATP",
	"FLOATP object [Function]",
	"FLOAT-PRECISION",
	"FLOAT-PRECISION f [Function]",
	"FLOAT-RADIX",
	"FLOAT-RADIX f [Function]",
	"FLOAT-SIGN",
	"FLOAT-SIGN f1 &optional (f2 (float 1 f1)) [Function]",
	"FLOOR",
	"FLOOR r &optional (d 1) [Function]",
	"FROUND",
	"FROUND r &optional (d 1) [Function]",
	"FTRUNCATE",
	"FTRUNCATE r &optional (d 1) [Function]",
	"GCD",
	"GCD &rest is [Function]",
	"IMAGPART",
	"IMAGPART n [Function]",
	"INCF",
	"INCF place [n] [Macro]",
	"INTEGER-DECODE-FLOAT",
	"INTEGER-DECODE-FLOAT f [Function]",
	"INTEGER-LENGTH",
	...
	"ISQRT i [Function]",
	"LCM",
	"LCM &rest is [Function]",
	"LDB",
	"LDB spec i [Function]",
	"LDB-TEST",
	"LDB-TEST spec i [Function]",
	"LOG",
	"LOG n1 &optional n2 [Function]",
	"LOGAND",
	"LOGAND &rest is [Function]",
	"LOGANDC1",
	"LOGANDC1 i1 i2 [Function]",
	"LOGANDC2",
	"LOGANDC2 i1 i2 [Function]",
	"LOGBITP",
	"LOGBITP pos i [Function]",
	"LOGCOUNT",
	"LOGCOUNT i [Function]",
	"LOGEQV",
	"LOGEQV &rest is [Function]",
	"LOGIOR",
	"LOGIOR &rest is [Function]",
	"LOGNAND",
	"LOGNAND i1 i2 [Function]",
	"LOGNOR",
	"LOGNOR i1 i2 [Function]",
	"LOGNOT",
	"LOGNOT i [Function]",
	"LOGORC1",
	"LOGORC1 i1 i2 [Function]",
	"LOGORC2",
	"LOGORC2 i1 i2 [Function]",
	"LOGTEST",
	"LOGTEST i1 i2 [Function]",
	"LOGXOR",
	...
	"PLUSP r [Function]",
	"RANDOM",
	"RANDOM limit &optional (state *random-state*) [Function]",
	"RANDOM-STATE-P",
	"RANDOM-STATE-P object [Function]",
	"RATIONAL",
	"RATIONAL r [Function]",
	"RATIONALIZE",
	"RATIONALIZE r [Function]",
	"RATIONALP",
	...
	"REM r1 r2 [Function]",
	"ROUND",
	"ROUND r &optional (d 1) [Function]",
	"SCALE-FLOAT",
	"SCALE-FLOAT f i [Function]",
	"SIGNUM",
	"SIGNUM n [Function]",
	"SIN",
	"SIN n [Function]",
	...
	"TANH n [Function]",
	"TRUNCATE",
	"TRUNCATE r &optional (d 1) [Function]",
	...
	"CHAR-EQUAL",
	"CHAR-EQUAL char1 &rest chars [Function]",
	"CHAR-INT",
	"CHAR-INT char [Function]",
	"CHAR-LESSP",
	"CHAR-LESSP char1 &rest chars [Function]",
	"CHAR-NAME",
	"CHAR-NAME char [Function]",
	"CHAR-NOT-GREATERP",
	"CHAR-NOT-GREATERP char1 &rest chars [Function]",
	"CHAR-NOT-EQUAL",
	"CHAR-NOT-EQUAL char1 &rest chars [Function]",
	"CHAR-NOT-LESSP",
	"CHAR-NOT-LESSP char1 &rest chars [Function]",
	"CHAR-UPCASE",
	"CHAR-UPCASE char [Function]",
	"CHAR=",
	"CHAR= char1 &rest chars [Function]",
	"CHAR/=",
	"CHAR/= char1 &rest chars [Function]",
	"CHAR>",
	"CHAR> char1 &rest chars [Function]",
	...
	"DIGIT-CHAR",
	"DIGIT-CHAR i &optional (r 10) [Function]",
	"DIGIT-CHAR-P",
	"DIGIT-CHAR-P char &optional (r 10) [Function]",
	"GRAPHIC-CHAR-P",
	...
	"ADJOIN",
	"ADJOIN object prolist &key key test test-not [Function]",
	"APPEND",
	"APPEND &rest prolists [Function]",
	"ASSOC",
	"ASSOC key alist &key key test test-not [Function]",
	"ASSOC-IF",
	...
	"TENTH list [Function]",
	"GETF",
	"GETF plist key &optional (default nil) [Function]",
	"GET-PROPERTIES",
	"GET-PROPERTIES plist prolist [Function]",
	"INTERSECTION",
	"INTERSECTION prolist1 prolist2 &key key test test-not [Function]",
	"NINTERSECTION",
	"NINTERSECTION <prolist1> prolist2 &key key test test-not [Function]",
	"LAST",
	"LAST list &optional (n 1) [Function]",
	"LDIFF",
	"LDIFF list object [Function]",
	"LIST",
	"LIST &rest objects [Function]",
	"LIST*",
	"LIST* object &rest objects [Function]",
	"LIST-LENGTH",
	"LIST-LENGTH list [Function]",
	"LISTP",
	"LISTP object [Function]",
	"MAKE-LIST",
	"MAKE-LIST n &key (initial-element nil) [Function]",
	"MAPC",
	...
	"MAPLIST",
	"MAPLIST function prolist &rest prolists [Function]",
	"MEMBER",
	...
	"PAIRLIS",
	"PAIRLIS key values &optional alist [Function]",
	"POP",
	"POP <place> [Macro]",
	"PUSH",
	...
	"SET-DIFFERENCE",
	"SET-DIFFERENCE prolist1 prolist2 &key key test test-not [Function]",
	"NSET-DIFFERENCE",
	"NSET-DIFFERENCE <prolist1> prolist2 &key key test test-not [Function]",
	"SET-EXCLUSIVE-OR",
	"SET-EXCLUSIVE-OR prolist1 prolist2 &key key test test-not [Function]",
	"NSET-EXCLUSIVE-OR",
	"NSET-EXCLUSIVE-OR <prolist1> <prolist2> &key key test test-not [Function]",
	"SUBLIS",
	"SUBLIS alist tree &key key test test-not [Function]",
	"NSUBLIS",
	"NSUBLIS alist <tree> &key key test test-not [Function]",
	"SUBSETP",
	"SUBSETP prolist1 prolist2 &key key test test-not [Function]",
	"SUBST",
	"SUBST new old tree &key key test test-not [Function]",
	"NSUBST",
	"NSUBST new old <tree> &key key test test-not [Function]",
	"SUBST-IF",
	"SUBST-IF new predicate tree &key key [Function]",
	"NSUBST-IF",
	"NSUBST-IF new predicate <tree> &key key [Function]",
	"SUBST-IF-NOT",
	"SUBST-IF-NOT new predicate tree &key key [Function]",
	"NSUBST-IF-NOT",
	"NSUBST-IF-NOT new predicate <tree> &key key [Function]",
	"TAILP",
	"TAILP object list [Function]",
	"TREE-EQUAL",
	"TREE-EQUAL tree1 tree2 &key test test-not [Function]",
	"UNION",
	"UNION prolist1 prolist2 &key key test test-not [Function]",
	"NUNION",
	"NUNION <prolist1> <prolist2> &key key test test-not [Function]",

	// Arrays
	"ADJUSTABLE-ARRAY-P",
	"ADJUSTABLE-ARRAY-P array [Function]",
	"ADJUST-ARRAY",
	"ADJUST-ARRAY <array> dimensions &key ... [Function]",
	"AREF",
	"AREF array &rest is [Function]",
	"ARRAY-DIMENSION",
	...
	"ARRAY-IN-BOUNDS-P",
	"ARRAY-IN-BOUNDS-P array &rest is [Function]",
	"ARRAYP",
	"ARRAYP object [Function]",
	"ARRAY-RANK",
	"ARRAY-RANK array [Function]",
	"ARRAY-ROW-MAJOR-INDEX",
	"ARRAY-ROW-MAJOR-INDEX array &rest is [Function]",
	"ARRAY-TOTAL-SIZE",
	"ARRAY-TOTAL-SIZE array [Function]",
	"BIT",
	"BIT bit-array &rest is [Function]",
	"BIT-AND",
	"BIT-AND <bit-array1> bit-array2 &optional <arg> [Function]",
	"BIT-ANDC1",
	"BIT-ANDC1 <bit-array1> bit-array2 &optional <arg> [Function]",
	"BIT-ANDC2",
	"BIT-ANDC2 <bit-array1> bit-array2 &optional <arg> [Function]",
	"BIT-EQV",
	"BIT-EQV <bit-array1> bit-array2 &optional <arg> [Function]",
	"BIT-IOR",
	"BIT-IOR <bit-array1> bit-array2 &optional <arg> [Function]",
	"BIT-NAND",
	"BIT-NAND <bit-array1> bit-array2 &optional <arg> [Function]",
	"BIT-NOR",
	"BIT-NOR <bit-array1> bit-array2 &optional <arg> [Function]",
	"BIT-NOT",
	"BIT-NOT <bit-array> &optional <arg> [Function]",
	"BIT-ORC1",
	"BIT-ORC1 <bit-array1> bit-array2 &optional <arg> [Function]",
	"BIT-ORC2",
	"BIT-ORC2 <bit-array1> bit-array2 &optional <arg> [Function]",
	"BIT-XOR",
	"BIT-XOR <bit-array1> bit-array2 &optional <arg> [Function]",
	"BIT-VECTOR-P",
	...
	"displaced-index-offset [Function]",
	"ROW-MAJOR-AREF",
	"ROW-MAJOR-AREF array i [Function]",
	"SBIT",
	"SBIT simple-bit-array &rest is [Function]",
	"SIMPLE-BIT-VECTOR-P",
	"SIMPLE-BIT-VECTOR-P object [Function]",
	"SVREF",
	"SVREF simple-vector i [Function]",
	"UPGRADED-ARRAY-ELEMENT-TYPE",
	"UPGRADED-ARRAY-ELEMENT-TYPE type &optional &env [Function]",
	"VECTOR",
	...
	"VECTOR-PUSH-EXTEND",
	"VECTOR-PUSH-EXTEND object vector &optional i [Function]",

	// Strings
	"CHAR",
	"CHAR string i [Function]",
	"MAKE-STRING",
	"MAKE-STRING n &key initial-element (element-type 'character) [Function]",
	"SCHAR",
	...
	"STRING-LEFT-TRIM",
	"STRING-LEFT-TRIM seq string [Function]",
	"STRING-LESSP",
	...
	"STRING-RIGHT-TRIM",
	"STRING-RIGHT-TRIM seq string [Function]",
	"STRING-TRIM",
	"STRING-TRIM seq string [Function]",
	"STRING=",
	...
	"COUNT-IF",
	"COUNT-IF predicate proseq &key key from-end start end [Function]",
	"COUNT-IF-NOT",
	"COUNT-IF-NOT predicate proseq &key key from-end start end [Function]",
	"ELT",
	"ELT proseq n [Function]",
	"FILL",
	"FILL <proseq> object &key start end [Function]",
	"FIND",
	"FIND object proseq &key key test test-not from-end start end [Function]",
	"FIND-IF",
	"FIND-IF predicate proseq &key key from-end start end [Function]",
	"FIND-IF-NOT",
	"FIND-IF-NOT predicate proseq &key key from-end start end [Function]",
	"LENGTH",
	"LENGTH proseq [Function]",
	"MAKE-SEQUENCE",
	"MAKE-SEQUENCE type n &key (initial-element nil) [Function]",
	"MAP",
	...
	"MISMATCH",
	"MISMATCH sequence1 sequence2 &key key test test-not from-end start1 end1 start2 end2 [Function]",
	"POSITION",
	"POSITION object proseq &key key test test-not from-end start end [Function]",
	"POSITION-IF",
	"POSITION-IF predicate proseq &key key from-end start end [Function]",
	"POSITION-IF-NOT",
	"POSITION-IF-NOT predicate proseq &key key from-end start end [Function]",
	"REDUCE",
	"REDUCE function proseq &key key from-end start end initial-value [Function]",
	"REMOVE",
	"REMOVE object proseq &key key test test-not from-end start end count [Function]",
	"DELETE",
	"DELETE object <proseq> &key key test test-not from-end start end count [Function]",
	"REMOVE-DUPLICATES",
	"REMOVE-DUPLICATES proseq &key key test test-not from-end start end [Function]",
	"DELETE-DUPLICATES",
	"DELETE-DUPLICATES <proseq> &key key test test-not from-end start end [Function]",
	"REMOVE-IF",
	"REMOVE-IF predicate proseq &key key from-end start end count [Function]",
	"DELETE-IF",
	"DELETE-IF predicate <proseq> &key key from-end start end count [Function]",
	"REMOVE-IF-NOT",
	"REMOVE-IF-NOT predicate proseq &key key from-end start end count [Function]",
	"DELETE-IF-NOT",
	"DELETE-IF-NOT predicate <proseq> &key key from-end start end count [Function]",
	"REPLACE",
	...
	"SEARCH",
	"SEARCH sequence1 sequence2 &key key test test-not from-end start1 end1 start2 end2 [Function]",
	"SORT",
	"SORT <proseq> predicate &key key [Function]",
	"STABLE-SORT",
	"STABLE-SORT <proseq> predicate &key key [Function]",
	"SUBSEQ",
	"SUBSEQ proseq start &optional end [Function]",
	"SUBSTITUTE",
	"SUBSTITUTE new old proseq &key key test test-not from-end start end count [Function]",
	"NSUBSTITUTE",
	"NSUBSTITUTE new old <proseq> &key key test test-not from-end start end count [Function]",
	"SUBSTITUTE-IF",
	"SUBSTITUTE-IF new predicate proseq &key key from-end start end count [Function]",
	"NSUBSTITUTE-IF",
	"NSUBSTITUTE-IF new predicate <proseq> &key key from-end start end count [Function]",
	"SUBSTITUTE-IF-NOT",
	"SUBSTITUTE-IF-NOT new predicate proseq &key key from-end start end count [Function]",
	"NSUBSTITUTE-IF-NOT",
	"NSUBSTITUTE-IF-NOT new predicate <proseq> &key key from-end start end count [Function]",
	...
	"WITH-HASH-TABLE-ITERATOR (symbol hash-table) declaration* expression* [Macro]",

	// Filenames
	"DIRECTORY-NAMESTRING",
	"DIRECTORY-NAMESTRING path [Function]",
	"ENOUGH-NAMESTRING",
	"ENOUGH-NAMESTRING path &optional path2 [Function]",
	"FILE-NAMESTRING",
	"FILE-NAMESTRING path [Function]",
	"HOST-NAMESTRING",
	"HOST-NAMESTRING path [Function]",
	"LOAD-LOGICAL-PATHNAME-TRANSLATIONS",
	"LOAD-LOGICAL-PATHNAME-TRANSLATIONS string [Function]",
	"LOGICAL-PATHNAME",
	"LOGICAL-PATHNAME path [Function]",
	"LOGICAL-PATHNAME-TRANSLATIONS",
	"LOGICAL-PATHNAME-TRANSLATIONS host [Function]",
	"MAKE-PATHNAME",
	"MAKE-PATHNAME &key host device directory name type version defaults case [Function]",
	"MERGE-PATHNAMES",
	"MERGE-PATHNAMES path &optional default-path version [Function]",
	"NAMESTRING",
	"NAMESTRING path [Function]",
	"PARSE-NAMESTRING",
	"PARSE-NAMESTRING path &optional host default &key start end junk-allowed [Function]",
	"PATHNAME",
	...
	"TRANSLATE-LOGICAL-PATHNAME path &key [Function]",
	"TRANSLATE-PATHNAME",
	"TRANSLATE-PATHNAME path1 path2 path3 &key [Function]",
	"WILD-PATHNAME-P",
	...
	"DIRECTORY",
	"DIRECTORY path &key [Function]",
	"ENSURE-DIRECTORIES-EXIST",
	"ENSURE-DIRECTORIES-EXIST path &key verbose [Function]",
	"FILE-AUTHOR",
	"FILE-AUTHOR path [Function]",
	"FILE-ERROR-PATHNAME",
	"FILE-ERROR-PATHNAME condition [Function]",
	"FILE-WRITE-DATE",
	"FILE-WRITE-DATE path [Function]",
	"PROBE-FILE",
	"PROBE-FILE path [Function]",
	"RENAME-FILE",
	"RENAME-FILE path1 path2 [Function]",
	"TRUENAME",
	...
	"FILE-POSITION",
	"FILE-POSITION stream &optional pos [Function]",
	"FILE-STRING-LENGTH",
	"FILE-STRING-LENGTH stream object [Function]",
	"FINISH-OUTPUT",
	...
	"OPEN",
	"OPEN path &key direction element-type if-exists if-does-not-exist external-format [Function]",
	"OPEN-STREAM-P",
	...
	"READ-BYTE",
	"READ-BYTE stream &optional eof-error eof-value [Function]",
	"READ-CHAR",
	"READ-CHAR &optional stream eof-error eof-value recursive [Function]",
	"READ-CHAR-NO-HANG",
	"READ-CHAR-NO-HANG &optional stream eof-error eof-value recursive [Function]",
	"READ-LINE",
	"READ-LINE &optional stream eof-error eof-value recursive [Function]",
	"READ-SEQUENCE",
	"READ-SEQUENCE <proseq> &optional stream &key start end [Function]",
	"STREAM-ELEMENT-TYPE",
	...
	"WITH-INPUT-FROM-STRING (symbol string &key index start end) declaration* expression* [Macro]",
	"WITH-OPEN-FILE",
	"WITH-OPEN-FILE (symbol path arg*) declaration* expression* [Macro]",
	"WITH-OPEN-STREAM",
	"WITH-OPEN-STREAM (symbol stream) declaration* expression* [Macro]",
	"WITH-OUTPUT-TO-STRING",
	"WITH-OUTPUT-TO-STRING (symbol [string] &key element-type) declaration* expression* [Macro]",
	"WRITE-BYTE",
	...
	"WRITE-SEQUENCE",
	"WRITE-SEQUENCE proseq &optional stream &key start end [Function]",
	"WRITE-STRING",
	"WRITE-STRING string &optional stream &key start end [Function]",
	"YES-OR-NO-P",
	"YES-OR-NO-P &optional format &rest args [Function]",
	"Y-OR-N-P",
	"Y-OR-N-P &optional format &rest args [Function]",

	// Printer
	"COPY-PPRINT-DISPATCH",
	"COPY-PPRINT-DISPATCH &optional pprint-dispatch [Function]",
	"FORMAT",
	"FORMAT dest format &rest args [Function]",
	"FORMATTER",
	"FORMATTER string [Macro]",
	"PPRINT",
	"PPRINT object &optional stream [Function]",
	"PPRINT-DISPATCH",
	"PPRINT-DISPATCH object &optional pprint-dispatch [Function]",
	"PPRINT-EXIT-IF-LIST-EXHAUSTED",
	"PPRINT-EXIT-IF-LIST-EXHAUSTED [Macro]",
	"PPRINT-FILL",
	"PPRINT-FILL stream object &optional colon at [Function]",
	"PPRINT-INDENT",
	"PPRINT-INDENT keyword r &optional stream [Function]",
	"PPRINT-LINEAR",
	"PPRINT-LINEAR stream object &optional colon at [Function]",
	"PPRINT-LOGICAL-BLOCK",
	"PPRINT-LOGICAL-BLOCK (symbol object &key prefix per-line-prefix suffix) declaration* expression* [Macro]",
	"PPRINT-NEWLINE",
	"PPRINT-NEWLINE keyword &optional stream [Function]",
	"PPRINT-POP",
	"PPRINT-POP [Macro]",
	"PPRINT-TAB",
	"PPRINT-TAB keyword i1 i2 &optional stream [Function]",
	"PPRINT-TABULAR",
	"PPRINT-TABULAR stream object &optional colon at tab [Function]",
	"PRINC",
	...
	"PRINT-NOT-READABLE-OBJECT condition [Function]",
	"PRINT-UNREADABLE-OBJECT",
	"PRINT-UNREADABLE-OBJECT (object stream &key type identity) expression* [Macro]",
	"PRIN1",
	"PRIN1 object &optional stream [Function]",
	"PRIN1-TO-STRING",
	"PRIN1-TO-STRING object [Function]",
	"SET-PPRINT-DISPATCH",
	"SET-PPRINT-DISPATCH type function &optional r pprint-dispatch [Function]",
	"WRITE",
	"WRITE object &key array base case circle escape gensym length level lines miser-width pprint-dispatch pretty "
	"radix readably right-margin stream [Function]",
	"WRITE-TO-STRING",
	"WRITE-TO-STRING object &key array base case circle escape gensym length level lines miser-width pprint-dispatch "
	"pretty radix readably right-margin stream [Function]",

	// Reader
	"COPY-READTABLE",
	"COPY-READTABLE &optional from <to> [Function]",
	"GET-DISPATCH-MACRO-CHARACTER",
	"GET-DISPATCH-MACRO-CHARACTER char1 char2 &optional readtable [Function]",
	"GET-MACRO-CHARACTER",
	"GET-MACRO-CHARACTER char &optional readtable [Function]",
	"MAKE-DISPATCH-MACRO-CHARACTER",
	"MAKE-DISPATCH-MACRO-CHARACTER char &optional nonterm readtable [Function]",
	"READ",
	"READ &optional stream eof-error eof-value recursive [Function]",
	"READ-DELIMITED-LIST",
	"READ-DELIMITED-LIST char &optional stream recursive [Function]",
	"READ-FROM-STRING",
	"READ-FROM-STRING string &optional eof-error eof-value &key start end preserve-whitespace [Function]",
	"READ-PRESERVING-WHITESPACE",
	"READ-PRESERVING-WHITESPACE &optional stream eof-error eof-value recursive [Function]",
	"READTABLE-CASE",
	"READTABLE-CASE readtable [Function]",
	"READTABLEP",
	"READTABLEP object [Function]",
	"SET-DISPATCH-MACRO-CHARACTER",
	"SET-DISPATCH-MACRO-CHARACTER char1 char2 function &optional readtable [Function]",
	"SET-MACRO-CHARACTER",
	"SET-MACRO-CHARACTER char function &optional nonterm readtable [Function]",
	"SET-SYNTAX-FROM-CHAR",
	"SET-SYNTAX-FROM-CHAR to-char from-char &optional to-readtable from-readtable [Function]",
	"WITH-STANDARD-IO-SYNTAX",
	"WITH-STANDARD-IO-SYNTAX expression* [Macro]",

	// System Construction
	"COMPILE-FILE",
	"COMPILE-FILE path &key output-file verbose print external-format [Function]",
	...
	"REQUIRE",
	"REQUIRE name &optional paths [Function]",
	"WITH-COMPILATION-UNIT",
	"WITH-COMPILATION-UNIT ([:override val]) expression* [Macro]",

	// Environment
	"APROPOS",
	"APROPOS name &optional package [Function]",
	"APROPOS-LIST",
	"APROPOS-LIST name &optional package [Function]",
	"DECODE-UNIVERSAL-TIME",
	"DECODE-UNIVERSAL-TIME i &optional time-zone [Function]",
	"DESCRIBE",
	"DESCRIBE object &optional stream [Function]",
	"DESCRIBE-OBJECT",
	"DESCRIBE-OBJECT object &optional stream [Generic Function]",
	"DISASSEMBLE",
	"DISASSEMBLE fn [Function]",
	"DOCUMENTATION",
	"DOCUMENTATION object symbol [Function]",
	"DRIBBLE",
	"DRIBBLE &optional path [Function]",
	"ED",
	...
	"ROOM",
	"ROOM &optional (arg :default) [Function]",
	"SHORT-SITE-NAME",
...
const char* findLambdaList(const char* symbol)
{
	LambdaListString* result =
		(LambdaListString*)bsearch(symbol, lambdaLists, numLambdaLists, sizeof(LambdaListString), lambdaKeyCompare);
	if (result)
