...
typedef long (*InitializeType)(const wchar_t* imageName, int clientType, HINSTANCE appInstance, HANDLE* thread,
...
int initLib()
{
	...
	ExportDirectory = (IMAGE_EXPORT_DIRECTORY*)(((char*)module) + optionalHeader->DataDirectory[0].VirtualAddress);
	...
	DWORD oldProtect;
	BOOL result =
		VirtualProtect((void*)(((DWORD)ExportAddressTable) & ~0xfff), PAGE_SIZE, PAGE_EXECUTE_READWRITE, &oldProtect);
	if (!result)
	{
		MessageBox(NULL, "Could not write to function address table of module", NULL, MB_OK | MB_ICONERROR);
		return -1;
	}
	...
	if (!ret)
	{
		...
		Console = CreateConsoleScreenBuffer(GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL,
		...
		LoadFuncPtrType LoadFuncPtr = (LoadFuncPtrType)GetCallbackFunctionPtr(L"LOAD_FILE", L"CCL");

		if (!LoadFuncPtr)
		{
			MessageBox(NULL, "Could not find function CCL::LOAD_FILE in lisp image", NULL, MB_OK | MB_ICONERROR);
			return -1;
		}
...
FuncPtr getFunction(int ordinal)
{
	...
	if (GetCallbackFunctionPtr)
	{
		...
		func = (FuncPtr)GetCallbackFunctionPtr(functionName, packageName[0] ? packageName : 0);
	}
	return func;
}
...
#define ExportedFunc(name, index)               \
	...
	{                                           \
		...
		__asm pop ebp __asm jmp dword ptr[func] \
	}

ExportedFunc(F001, 1) ExportedFunc(F002, 2) ExportedFunc(F003, 3) ExportedFunc(F004, 4) ExportedFunc(F005, 5)
	ExportedFunc(F006, 6) ExportedFunc(F007, 7) ExportedFunc(F008, 8) ExportedFunc(F009, 9) ExportedFunc(
		F010, 10) ExportedFunc(F011, 11) ExportedFunc(F012, 12) ExportedFunc(F013, 13) ExportedFunc(F014, 14)
		ExportedFunc(F015, 15) ExportedFunc(F016, 16) ExportedFunc(F017, 17) ExportedFunc(F018, 18) ExportedFunc(
			F019, 19) ExportedFunc(F020, 20) ExportedFunc(F021, 21) ExportedFunc(F022, 22) ExportedFunc(F023, 23)
			ExportedFunc(F024, 24) ExportedFunc(F025, 25) ExportedFunc(F026, 26) ExportedFunc(F027, 27) ExportedFunc(
				F028, 28) ExportedFunc(F029,
									   29) ExportedFunc(F030, 30)
				ExportedFunc(F031, 31) ExportedFunc(F032, 32) ExportedFunc(F033, 33) ExportedFunc(F034, 34)
					ExportedFunc(F035, 35) ExportedFunc(F036, 36) ExportedFunc(F037, 37) ExportedFunc(F038, 38)
						ExportedFunc(F039, 39) ExportedFunc(F040, 40) ExportedFunc(F041, 41) ExportedFunc(F042, 42)
							ExportedFunc(F043, 43) ExportedFunc(F044, 44) ExportedFunc(F045, 45) ExportedFunc(F046, 46)
								ExportedFunc(F047, 47) ExportedFunc(F048, 48) ExportedFunc(F049, 49) ExportedFunc(
									F050, 50) ExportedFunc(F051,
														   51) ExportedFunc(F052, 52)
									ExportedFunc(F053, 53) ExportedFunc(F054, 54) ExportedFunc(F055, 55) ExportedFunc(
										F056, 56) ExportedFunc(F057,
															   57) ExportedFunc(F058, 58)
										ExportedFunc(F059, 59) ExportedFunc(F060, 60) ExportedFunc(F061, 61)
											ExportedFunc(F062, 62) ExportedFunc(F063, 63) ExportedFunc(F064, 64)
												ExportedFunc(F065, 65) ExportedFunc(F066, 66) ExportedFunc(F067, 67)
													ExportedFunc(F068, 68) ExportedFunc(F069, 69) ExportedFunc(F070, 70)
														ExportedFunc(F071, 71) ExportedFunc(F072, 72) ExportedFunc(
															F073, 73) ExportedFunc(F074,
																				   74) ExportedFunc(F075, 75)
															ExportedFunc(F076, 76) ExportedFunc(F077, 77) ExportedFunc(
																F078, 78) ExportedFunc(F079,
																					   79) ExportedFunc(F080, 80)
																ExportedFunc(F081, 81) ExportedFunc(
																	F082, 82) ExportedFunc(F083,
																						   83) ExportedFunc(F084, 84)
																	ExportedFunc(F085, 85) ExportedFunc(F086, 86)
																		ExportedFunc(F087, 87) ExportedFunc(F088, 88)
																			ExportedFunc(F089, 89) ExportedFunc(
																				F090, 90) ExportedFunc(F091, 91)
																				ExportedFunc(F092,
																							 92) ExportedFunc(F093, 93)
																					ExportedFunc(F094, 94) ExportedFunc(
																						F095, 95) ExportedFunc(F096, 96)
