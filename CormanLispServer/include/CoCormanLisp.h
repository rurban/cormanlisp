...
class CoCormanLisp : public ICormanLisp, public IConnectionPointContainer, public ICormanLispDirectCall
{
public:
	CoCormanLisp();
	~CoCormanLisp();
	...
	STDMETHODIMP InitializeEx(IUnknown* clientInterface, const char* imageName, int clientType, int heapReserve,
